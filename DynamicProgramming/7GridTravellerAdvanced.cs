...
namespace DynamicProgramming
{
    ...
    // You may only move down or right or diagonally down

    //In how many ways you can travel to the goal on the grid if you have dimension M*N
    public class GridTravellerAdvanced
    {
        ...
        public int GridTravellerWays(int m, int n)
        {
            ...
            return GridTravellerWays(m - 1, n) + GridTravellerWays(m, n - 1) + GridTravellerWays(m -1, n-1);
        }
        ...
        private long GridTravellerHelper(int m, int n, Dictionary<string, long> memo)
        {
            ...
            memo[key] = GridTravellerHelper(m - 1, n, memo) + GridTravellerHelper(m, n - 1, memo) + GridTravellerHelper(m-1, n-1, memo);
